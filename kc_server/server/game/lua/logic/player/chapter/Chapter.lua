...
function Chapter:ReqNextWave(killCount)
    ...
    --6元礼包经验比例
    local isSixYuanUp = self.player:isSixYuanUp()
    -- print("-----Chapter:ReqNextWave rewardUp----",isSixYuanUp)

    local rewardUp = isVipCard + isForeverUp + isSixYuanUp
    if rewardUp ~= 0 then
