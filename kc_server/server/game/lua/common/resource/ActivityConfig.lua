...
ActivityConfig.ActivityDiscountShop = 26 		--折扣商店 (神秘商店)
ActivityConfig.ActivityRebate = 27 				--充值返利
ActivityConfig.DailyRecharge = 28 				--每日壕充
ActivityConfig.ActivitySixYuan = 30 			--六元礼包
ActivityConfig.ActivityYiYuan = 31 				--一元礼包
...
--暂定giftid（直接人民币购买）
ActivityConfig.YiYunGiftIdStart = 41
ActivityConfig.YiYunGiftIdEnd = 53
ActivityConfig.SixYunGiftId = 54
